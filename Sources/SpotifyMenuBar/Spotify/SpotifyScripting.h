...
@class SpotifyScriptingApplication, SpotifyScriptingTrack, SpotifyScriptingApplication;

enum SpotifyScriptingEPlS {
	SpotifyScriptingEPlSStopped = 'kPSS',
	SpotifyScriptingEPlSPlaying = 'kPSP',
	SpotifyScriptingEPlSPaused = 'kPSp'
};
typedef enum SpotifyScriptingEPlS SpotifyScriptingEPlS;
...
@interface SpotifyScriptingApplication : SBApplication

@property (copy, readonly) SpotifyScriptingTrack *currentTrack;  // The current playing track.
@property NSInteger soundVolume;  // The sound output volume (0 = minimum, 100 = maximum)
@property (readonly) SpotifyScriptingEPlS playerState;  // Is Spotify stopped, paused, or playing?
...
// A Spotify track.
@interface SpotifyScriptingTrack : SBObject
...
@interface SpotifyScriptingApplication (StandardSuite)
